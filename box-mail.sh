...
SERVER_IP="94.237.118.194" # Replace with your actual server IP
DOMAIN="mamunrahman.com" # Replace with your domain
HOSTNAME="mail.${DOMAIN}"
DEFAULT_EMAIL="testmail@${DOMAIN}"
DEFAULT_PASSWORD="TestMailRumon"
...
# Add default email user
echo "Adding default email user..."
ENCRYPTED_PASSWORD=$(doveadm pw -s SHA512-CRYPT -p ${DEFAULT_PASSWORD})
sudo mysql -u root -pyour-root-password postfixadmin <<EOF
INSERT INTO mailbox (username, domain, password, maildir, quota, active)
VALUES ('${DEFAULT_EMAIL}', '${DOMAIN}', '${ENCRYPTED_PASSWORD}', '${DEFAULT_EMAIL}/', 0, 1);
INSERT INTO alias (address, goto, domain, active)
VALUES ('${DEFAULT_EMAIL}', '${DEFAULT_EMAIL}', '${DOMAIN}', 1);
EOF
...
echo "Default email user: ${DEFAULT_EMAIL}, Password: ${DEFAULT_PASSWORD}"
